...
public class SetWebviewPermission {
    ...
    public void permissionRequest() {
        ...
        ContextCompat.checkSelfPermission(this.mActivity, Manifest.permission.POST_NOTIFICATIONS)!= PackageManager.PERMISSION_GRANTED
 ) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(mActivity, Manifest.permission.ACCESS_FINE_LOCATION)||
                    ...
                    ActivityCompat.shouldShowRequestPermissionRationale(mActivity, Manifest.permission.POST_NOTIFICATIONS)
            ) {
